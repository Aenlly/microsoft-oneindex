    ...
    <div class="mdui-typo">
        <h4 class="doc-article-title">
            ...
            <a href="<?php echo $app_url; ?>" target="_blank"
               class="mdui-btn mdui-color-theme-accent mdui-ripple"><i class="mdui-icon material-icons">&#xe89e;</i>
                获取应用ID和机密(分两个页面显示，请注意保存)</a>
        </h4>
    </div>
    ...
    <form action="" method="post">
        <div class="mdui-textfield mdui-textfield-floating-label">
            ...
            <input type="text" type="text" class="mdui-textfield-input" name="client_secret" required
                   value="<?php echo config('client_secret'); ?>"/>
        ...
        <div class="mdui-textfield mdui-textfield-floating-label">
            ...
            <input type="text" class="mdui-textfield-input" name="client_id" required
                   value="<?php echo config('client_id'); ?>"/>
        ...
        <div class="mdui-textfield mdui-textfield-floating-label">
            ...
            <input type="hidden" class="mdui-textfield-input" name="redirect_uri"
