        ...
        <form action="" method="post">
            ...
            <div class="mdui-col-xs-2" style="padding-top: 34px;">
                <button type="submit" name="upload" value="1"
                        class="mdui-btn mdui-btn-block mdui-color-green-600 mdui-ripple">
                ...
                <?php foreach ((array)$uploading as $i => $task): ?>
                    <tr>
                        ...
                        <?php if ($task['update_time'] == 0): ?>
                            ...
                            <td>
                                <button name="begin_task" class="mdui-btn mdui-color-green-600 mdui-ripple"
                                        type="submit" name="remotepath" value="<?php echo $task['remotepath']; ?>">
                                    上传
                                </button>
                            </td>
                        ...
                        <?php else: ?>
                            <td>上传中</td>
                            <td>
                                <button name="delete_task" class="mdui-btn mdui-color-red mdui-ripple" type="submit"
                                        name="remotepath" value="<?php echo $task['remotepath']; ?>">删除
                                </button>
                            </td>
                        <?php endif; ?>
                    </tr>
        ...
        <form action="" method="post">
            <h5>已上传
                <small>
                    ...
                    <button name="empty_uploaded" value="1" class="mdui-btn mdui-color-red mdui-ripple"
                            type="submit" name="remotepath">清空已上传记录
                    </button>
